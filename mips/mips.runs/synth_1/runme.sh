...
HD_PWD='C:/Users/ZhangFirst1/Desktop/cclab/mips/mips.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_min_sopc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mips_min_sopc.tcl
